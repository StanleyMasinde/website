  ...
  <div>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="/me.png" alt />

        <!-- Masthead Heading -->
        <h2 class="masthead-heading text-uppercase mb-0">Stanley Masinde</h2>
        ...
        <p class="masthead-subheading font-weight-light mb-0">
          Fullstack Developer - Penetration tester - Speaker
        </p>
      </div>
    </header>
